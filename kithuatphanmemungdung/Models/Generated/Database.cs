...
//     Connection String:      `Data Source=DESKTOP-T0OFKLC\SQLEXPRESS;Initial Catalog=DealBook;Integrated Security=True`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace ShopOnlineConnection
{
	...
	[PrimaryKey("MaNhaXuatBan", AutoIncrement=false)]


	[ExplicitColumns]

    public partial class NhaXuatBan : ShopOnlineConnectionDB.Record<NhaXuatBan>  
    {



		[Column] public string MaNhaXuatBan { get; set; }





		[Column] public string TenNhaXuatBan { get; set; }
    ...
    public partial class SanPham : ShopOnlineConnectionDB.Record<SanPham>  
    {
		...
		[Column] public string GiaBia { get; set; }





		[Column] public string TietKiem { get; set; }





		[Column] public string GiamGia { get; set; }





		[Column] public string TacGia { get; set; }





		[Column] public string DichGia { get; set; }
		...
		[Column] public string Combo { get; set; }
